...
const menuItems: MenuItem[] = [
  ...
  { label: 'Painel de Gestão', icon: Flame, path: '/gestao-ti/painel-chamados', funcionalidade: 'CHAMADO' },
  ...
  { label: 'Painel de Gestão', icon: ListChecks, path: '/gestao-ti/painel-projetos', roles: [...STAFF, 'USUARIO_CHAVE', 'TERCEIRIZADO'], funcionalidade: 'PROJETO' },
