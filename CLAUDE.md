...
- **⭐ RDV — as 6 regras de integridade** (onda 31/07–01/08, `40db4ac`..`8866090`; regras 5 e 6 de 21–22/08, `4f3ce3e0`..`ea5674db`), que valem para qualquer mexida futura no módulo:
...
- **Aprendizado de campo na Entrega** (`LocalAprendidoService`): o GPS das entregas feitas ensina onde o endereço realmente fica. Promove com **3 baixas concordantes** em **80 m** do **medóide** (não média — outlier não desloca); divergindo >**300 m** do provedor, usa e **sinaliza**; **MANUAL vence CAMPO**. Entra no cache como `fonte=CAMPO` → vale para toda entrega futura naquele endereço, de qualquer cliente (quem manda é o LUGAR). Mesmo critério do `LocalCliente` do RDV.
