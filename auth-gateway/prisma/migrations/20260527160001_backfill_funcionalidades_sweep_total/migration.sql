-- ============================================================================
-- S16.5 (27/05) — Backfill funcionalidades sweep total (parte 2/2)
-- ============================================================================
-- Pré-requisito: migration 20260527160000_add_funcionalidades_sweep_total
-- já comitada (10 valores novos presentes no enum).
--
-- Backfill: ativa as 10 funcionalidades novas APENAS em T.I. — preserva
-- status quo (T.I. tinha todo o menu visível antes do sweep). Demais
-- deptos ativam manualmente via Configurador conforme uso.
-- ============================================================================
