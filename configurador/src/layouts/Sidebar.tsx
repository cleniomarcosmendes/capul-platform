...
const menuItems: MenuItem[] = [
  ...
  { label: 'Tipos Departamento', icon: Layers, path: '/configurador/tipos-departamento', roles: ADMINS },
  ...
  { label: 'Usuarios Online', icon: Wifi, path: '/configurador/usuarios-online', roles: ADMINS },
