-- ===============================================
-- ESTRUTURA SBZ010 - PARÂMETROS POR FILIAL (SIMPLIFICADA)
-- ===============================================
...
-- Criar a tabela com a estrutura exata solicitada
...
COMMENT ON COLUMN inventario.sbz010.bz_cod IS 'Código do produto';
...
('001', 'PROD006', '01', 'EST-D-01', 'PRATELEIRA-D1', 'NIVEL-1'),
('001', 'PROD007', '01', 'EST-D-02', 'PRATELEIRA-D2', 'NIVEL-1'),
('001', 'PROD008', '02', 'EST-E-01', 'PRATELEIRA-E1', 'NIVEL-2'),
('001', 'PROD009', '02', 'EST-E-02', 'PRATELEIRA-E2', 'NIVEL-2'),
('001', 'PROD010', '01', 'EST-F-01', 'PRATELEIRA-F1', 'NIVEL-3'),
('002', 'PROD001', '01', 'FIL2-A-01', 'PRAT-2A1', 'NIV-1'),
('002', 'PROD002', '01', 'FIL2-A-02', 'PRAT-2A2', 'NIV-1'),
('002', 'PROD003', '02', 'FIL2-B-01', 'PRAT-2B1', 'NIV-2');
