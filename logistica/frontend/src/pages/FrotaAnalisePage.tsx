...
import { Banknote, Building2, Car, ChevronLeft, ChevronRight, Layers, Loader2, RefreshCw, Tag, X } from 'lucide-react';
...
interface Analitico {
  total: number;
  porVeiculo: Grupo[]; porTipo: Grupo[]; porFornecedor: Grupo[]; porDepartamento: Grupo[];
}
