...
import { AcertoViagemPrintPage } from './pages/AcertoViagemPrintPage';
...
import { LinhaKmPage } from './pages/LinhaKmPage';
        ...
        element={
          <Layout>
            <Routes>
              ...
              <Route path="/frota/viagens/:id/acerto" element={<AcertoViagemPrintPage />} />
